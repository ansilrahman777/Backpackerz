...
from .views import CancelHotelBookingAPIView, HotelBookingListByHotelAPIView, HotelReviewListCreateAPIView, RegisterUserView ,VerifyUserEmail ,LoginUserView ,PasswordResetConfirm ,PasswordResetRequestView ,SetNewPassword ,LogoutUserView ,TestLogin
...
urlpatterns = [
    ...
    path('bookings/<int:pk>/cancel/', CancelHotelBookingAPIView.as_view(), name='cancel-booking'),
