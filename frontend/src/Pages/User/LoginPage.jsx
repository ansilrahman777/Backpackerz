    ...
    <>
      ...
      >
        ...
        <div className="container mx-auto mt-10 px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row w-full md:w-10/12 lg:w-8/12 bg-sky-300 bg-opacity-70 mx-auto rounded-md overflow-hidden shadow-lg">
            <div
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center justify-center py-16 px-8 sm:px-12">
                ...
                <div className="flex items-center justify-center mt-4">
                  <div className="text-center">
                    <p>
                      <Link
                        to="/forgot-password"
                        className="text-white text-sm hover:text-blue-700"
                      >
                        Forgot password?
                      </Link>
                    </p>
