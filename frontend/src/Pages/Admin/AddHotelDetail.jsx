...
function AddHotelDetail({ hotelId }) {
  ...
  const validateDetail = () => {
    ...
    if (!detail || detail.length < 5 || !alphaNumRegex.test(detail)) {
      formErrors.detail = "Detail should be at least 5 characters long and only contain alphabets, numbers, and spaces.";
    }
  ...
  return (
    <div className="m-3">
      <h3 className="text-lg font-medium leading-6 text-gray-900">Add Hotel Deatils</h3>
